...
public class SalientEventsProlog {
	String[] events;
	String prologPath;
	String result;
	String event;
	...
	public SalientEventsProlog(String[] events, String prologPath, String event, int currentTick) {
		this.events = events;	
